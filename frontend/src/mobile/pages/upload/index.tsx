				...
				<div className="info-container">
					...
					<div className="form-group">
						<h5>
							...
							<span>
								TikTok identifies music used in the video automatically, but no
								such feature exists here so you gotta type it manually. Can also
								be left blank. Example: Rick Astley - Never gonna give you up
							</span>
						</h5>
						<Input
							isMobile
